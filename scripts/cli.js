...
const contractABI = require("../artifacts/contracts/Analogprime.sol/Analogprime.json").abi;

program
    .name("analogprime-cli")
    .description("CLI tool for Analogprime smart contract")
    .version("1.0.0");
